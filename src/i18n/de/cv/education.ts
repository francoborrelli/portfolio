...
const APU = {
  ...
  APU_ARTIST: 'Fakultät für Informatik | UNLP',
  APU_LENGTH: 'Feb 2015 - Nov 2019',
  APU_DESCRIPTION: `Abschlussnote: 9,19/10\nDie Analyst Programmer Karriere zielt darauf ab, Absolventen mit grundlegendem Wissen über die Grundlagen der Disziplin und aktuelle Technologien auszubilden, wodurch sie für professionelle Arbeit in Systemen kleiner und mittlerer Komplexität qualifiziert werden.\nDie Arbeitsrealität an der Fakultät zeigt, dass eine beträchtliche Anzahl von Studenten vor dem Abschluss in den Markt eintritt, hauptsächlich in der Programm- und Systementwicklung, für die ein grundlegendes Verständnis der Grundlagen der Disziplin und die Entwicklung von Problemlösungsfähigkeiten durch Fächer mit intensiver Praxis erforderlich sind. Dies ist das Profil, das mit der UAP angestrebt wird, um die Wettbewerbsfähigkeit der Studenten zu verbessern. Zusätzlich können Absolventen ihre Studien in Systemen oder Informatik ohne größere Schwierigkeiten fortsetzen.`,
};

const LICENCIATURA = {
  LICENCIATURA_NAME: `Bachelor-Abschluss in Systemen`,
  LICENCIATURA_ARTIST: 'Fakultät für Informatik | UNLP',
  LICENCIATURA_LENGTH: 'Feb 2015 - März 2021',
  LICENCIATURA_DESCRIPTION: `Abschlussnote: 9,35/10\nDer Bachelor-Abschluss in Systemen ist international von EUROINF zertifiziert.\nDas Profil des Absolventen im Bachelor-Abschluss in Systemen ist das eines Fachmanns, der besonders auf den Markt ausgerichtet ist, der mit Computersystemen verbunden ist, insbesondere die Aspekte im Zusammenhang mit Software- und Datenverwaltung innerhalb einer Organisation. Die Grundausbildung ermöglicht auch die Teilnahme an Forschungs-, Entwicklungs- und Innovationsaktivitäten innerhalb der Disziplin.`,
};

const ENGLISH_CAMBRIDGE = {
  ENGLISH_CAMBRIDGE_NAME: 'Cambridge English: First (FCE) – CEFR Niveau C1',
  ENGLISH_CAMBRIDGE_ARTIST: 'Cambridge University Press & Assessment English',
  ENGLISH_CAMBRIDGE_LENGTH: 'Dez 2014',
  ENGLISH_CAMBRIDGE_DESCRIPTION: `Note: A\nDie Cambridge English: Advanced (CAE) Zertifizierung ist ein Nachweis für hochwertige Englischkenntnisse für akademische und berufliche Zwecke. Sie wird von Universitäten und Arbeitgebern weltweit als Demonstration der Englischkenntnisse anerkannt.`,
};

const MIKROWAYS_KUBERNETES = {
  MIKROWAYS_KUBERNETES_NAME: 'Grundlagen von Kubernetes',
  MIKROWAYS_KUBERNETES_ARTIST: 'Mikroways',
  MIKROWAYS_KUBERNETES_LENGTH: 'Feb 2020',
  MIKROWAYS_KUBERNETES_DESCRIPTION: `Dieser Kurs vermittelte mir ein umfassendes Verständnis von Kubernetes, einer leistungsstarken Container-Orchestrierungsplattform. Ich lernte, wie man containerisierte Anwendungen mit Kubernetes bereitstellt, verwaltet und skaliert, wodurch ich die Leistung und Zuverlässigkeit meiner Anwendungen optimieren kann.`,
};

const REACT_UDEMY = {
  REACT_UDEMY_NAME: 'React - Der vollständige Leitfaden',
  REACT_UDEMY_ARTIST: 'Udemy',
  REACT_UDEMY_LENGTH: 'März 2018',
  REACT_UDEMY_DESCRIPTION: `Dieser Kurs vermittelte mir die Fähigkeiten, moderne, dynamische Webanwendungen mit React zu entwickeln. Ich lernte, wiederverwendbare Komponenten zu erstellen, den Anwendungszustand mit React Hooks zu verwalten und Routing und Zustandsverwaltung mit React Router und Redux zu integrieren. Diese Ausbildung war entscheidend für die Verbesserung meiner Fähigkeiten in der Frontend-Entwicklung und die Erweiterung meines Werkzeugkastens an Technologien und Frameworks.`,
};

const FISCALIA = {
  FISCALIA_NAME: 'Web-Entwicklung mit REST-Architektur',
  FISCALIA_ARTIST: 'Fiscalía de Estado | Provinz Buenos Aires',
  FISCALIA_LENGTH: 'Feb 2019',
  FISCALIA_DESCRIPTION: `Der Kurs konzentrierte sich darauf, mir die Entwicklung mit der REST-Architektur beizubringen, mit einer Einführung in die Backend-Entwicklung mit .NET und Frontend-Entwicklung mit Angular. Ich lernte, effiziente Webdienste mit .NET zu erstellen und Webanwendungen mit Angular zu bauen. Am Ende des Kurses hatte ich Fähigkeiten erworben, moderne und skalierbare Webanwendungen zu entwickeln, die den Industriestandards entsprechen.`,
};

const ANGULAR_UDEMY = {
  ANGULAR_UDEMY_NAME: 'Angular: Von Null zum Experten',
  ANGULAR_UDEMY_ARTIST: 'Udemy',
  ANGULAR_UDEMY_LENGTH: 'Mai 2019',
  ANGULAR_UDEMY_DESCRIPTION: `Dieser Kurs vermittelte mir ein umfassendes Verständnis von Angular, einem leistungsstarken Frontend-Framework. Ich lernte, wie man dynamische Webanwendungen mit Angular erstellt, einschließlich der Erstellung wiederverwendbarer Komponenten, der Verwaltung des Anwendungszustands und der Integration von Routing und Zustandsverwaltung. Diese Ausbildung war entscheidend für die Verbesserung meiner Fähigkeiten in der Frontend-Entwicklung und die Erweiterung meines Werkzeugkastens an Technologien und Frameworks.`,
};

const MAGISTER_DATA_ANALYSIS = {
  MAGISTER_DATA_ANALYSIS_NAME: `Master-Abschluss in Data Intelligence mit Schwerpunkt auf Big Data`,
  MAGISTER_DATA_ANALYSIS_ARTIST: 'Fakultät für Informatik | UNLP',
  MAGISTER_DATA_ANALYSIS_LENGTH: 'März 2021 - Juli 2024',

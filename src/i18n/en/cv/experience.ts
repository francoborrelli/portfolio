...
const LBS = {
  ...
  LBS_JOB_DESCRIPTION:
    'At LBS Informática, I worked on several projects using React for frontend development and Laravel and Next.js for backend development. This experience helped me build strong skills in both areas and deliver efficient solutions for our clients.',
};

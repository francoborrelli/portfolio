...
export const SoundSuitWebApp = {
  name: 'SOUNDSUIT_WEB_APP_NAME',
  artist: 'SOUNDSUIT_WEB_APP_ARTIST',
  length: 'SOUNDSUIT_WEB_APP_LENGTH',
  ...
  images: [
    getProjectPath('soundsuit_web/1.png'),
    getProjectPath('soundsuit_web/2.png'),
    getProjectPath('soundsuit_web/3.png'),
    getProjectPath('soundsuit_web/4.png'),
    getProjectPath('soundsuit_web/5.png'),
    getProjectPath('soundsuit_web/6.png'),
    getProjectPath('soundsuit_web/7.png'),
    getProjectPath('soundsuit_web/8.png'),
    getProjectPath('soundsuit_web/9.png'),
  ],
} as Song;

export const SoundSuitMobileApp = {
  name: 'SOUNDSUIT_MOBILE_APP_NAME',
  artist: 'SOUNDSUIT_MOBILE_APP_ARTIST',
  ...
  images: [
    getProjectPath('soundsuit_mobile/1.png'),
    getProjectPath('soundsuit_mobile/2.png'),
    getProjectPath('soundsuit_mobile/3.png'),
    getProjectPath('soundsuit_mobile/4.png'),
    getProjectPath('soundsuit_mobile/5.png'),
    getProjectPath('soundsuit_mobile/6.png'),
    getProjectPath('soundsuit_mobile/7.png'),
    getProjectPath('soundsuit_mobile/8.png'),
    getProjectPath('soundsuit_mobile/9.png'),
    getProjectPath('soundsuit_mobile/10.png'),
    getProjectPath('soundsuit_mobile/11.png'),
    getProjectPath('soundsuit_mobile/12.png'),
    getProjectPath('soundsuit_mobile/13.png'),
  ],
} as Song;
